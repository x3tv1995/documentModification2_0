...
@Component("ПБ15")
public class Pb15EquipmentHandler implements EquipmentHandler, EquipmentHandlerForPsi {
    @Autowired
    ...
    public void handler(String pathExcel, String docPath, String pathDirectory,
        ...
        String patternFirst = CodeMapping.PB15_PATTERN_FIRST.getDescription();
        String patternDate = CodeMapping.PB15_PATTERN_DATE.getDescription();
        String patternSpace = CodeMapping.PB15_PATTERN_SPACEANDSIZEWORD.getDescription();
        String numberSearch = CodeMapping.PB15_PATTERN_NUMBER_SEARCH.getDescription();
        String patternNumber = CodeMapping.PB15_PATTERN_NUMBER.getDescription();
        String replaceNumber = CodeMapping.PB15_PATTERN_REPLACE_NUMBER.getDescription();
        int fontSize = CodeMapping.PB15_PATTERN_SPACEANDSIZEWORD.getSize();
