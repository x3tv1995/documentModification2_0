...
@Component("РПП")
public class RppEquipmentHandler implements EquipmentHandler, EquipmentHandlerForPsi {
    @Autowired
    ...
    public void handler(EquipmentProcessingRequest equipmentProcessingRequest) throws Exception {
        ...
        String patternFirst = CodeMapping.RPP_PATTERN_FIRST.getDescription();
        String patternDate = CodeMapping.RPP_PATTERN_DATE.getDescription();
        String patternSpace = CodeMapping.RPP_PATTERN_SPACEANDSIZEWORD.getDescription();
        String numberSearch = CodeMapping.RPP_PATTERN_NUMBER_SEARCH.getDescription();
        String patternNumber = CodeMapping.RPP_PATTERN_NUMBER.getDescription();
        String replaceNumber = CodeMapping.RPP_PATTERN_REPLACE_NUMBER.getDescription();
        int fontSize = CodeMapping.RPP_PATTERN_SPACEANDSIZEWORD.getSize();
    ...
    public void handlerPsi(String lastName, XWPFDocument document, int sizeText) {
        String patternFirst = CodeMapping.RPP_PSI_PATTERN_FIRST.getDescription();
        String patternDate =  CodeMapping.RPP_PSI_PATTERN_DATE.getDescription();
