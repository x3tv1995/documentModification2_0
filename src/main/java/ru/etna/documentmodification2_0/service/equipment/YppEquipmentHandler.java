...
@Component("УПП")
public class YppEquipmentHandler extends AbstractEquipmentHandler {


    public YppEquipmentHandler(StartupManagerService startupManagerService, DocxUpdateTextService docxUpdateTextService) {
