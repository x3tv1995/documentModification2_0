...
@Component("НПЭК")
public class NpekEquipmentHandler implements EquipmentHandler, EquipmentHandlerForPsi {
    @Autowired
    ...
    public void handler(String pathExcel, String docPath, String pathDirectory,
        ...
        String patternFirst = CodeMapping.NPEK_PATTERN_FIRST.getDescription();
        String patternDate = CodeMapping.NPEK_PATTERN_DATE.getDescription();
        String patternSpace = CodeMapping.NPEK_PATTERN_SPACEANDSIZEWORD.getDescription();
        String numberSearch = CodeMapping.NPEK_PATTERN_NUMBER_SEARCH.getDescription();
        String patternNumber = CodeMapping.NPEK_PATTERN_NUMBER.getDescription();
        String replaceNumber = CodeMapping.NPEK_PATTERN_REPLACE_NUMBER.getDescription();
        int fontSize = CodeMapping.NPEK_PATTERN_SPACEANDSIZEWORD.getSize();
