...
@Component("НР4")
public class Nr4EquipmentHandler implements EquipmentHandler, EquipmentHandlerForPsi {
    @Autowired
    ...
    public void handler(String pathExcel, String docPath, String pathDirectory,
        ...
        String patternFirst = CodeMapping.NR4_PATTERN_FIRST.getDescription();
        String patternDate = CodeMapping.NR4_PATTERN_DATE.getDescription();
        String patternSpace = CodeMapping.NR4_PATTERN_SPACEANDSIZEWORD.getDescription();
        String numberSearch = CodeMapping.NR4_PATTERN_NUMBER_SEARCH.getDescription();
        String patternNumber = CodeMapping.NR4_PATTERN_NUMBER.getDescription();
        String replaceNumber = CodeMapping.NR4_PATTERN_REPLACE_NUMBER.getDescription();
        int fontSize = CodeMapping.NR4_PATTERN_SPACEANDSIZEWORD.getSize();
