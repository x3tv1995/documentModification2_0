...
@Component("БТР14")
public class Btr14EquipmentHandler implements EquipmentHandler, EquipmentHandlerForPsi {
    @Autowired
    ...
    public void handler(EquipmentProcessingRequest equipmentProcessingRequest) throws Exception {
        ...
        String patternFirst = CodeMapping.BTR14_PATTERN_FIRST.getDescription();
        String patternDate = CodeMapping.BTR14_PATTERN_DATE.getDescription();
        String patternSpace = CodeMapping.BTR14_PATTERN_SPACEANDSIZEWORD.getDescription();
        String numberSearch = CodeMapping.BTR14_PATTERN_NUMBER_SEARCH.getDescription();
        String patternNumber = CodeMapping.BTR14_PATTERN_NUMBER.getDescription();
        String replaceNumber = CodeMapping.BTR14_PATTERN_REPLACE_NUMBER.getDescription();
        int fontSize = CodeMapping.BTR14_PATTERN_SPACEANDSIZEWORD.getSize();
