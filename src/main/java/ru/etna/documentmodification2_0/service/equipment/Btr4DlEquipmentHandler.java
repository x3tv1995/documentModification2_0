...
@Component("БТР4ДЛ")
public class Btr4DlEquipmentHandler implements EquipmentHandler, EquipmentHandlerForPsi {
    @Autowired
    ...
    public void handler(EquipmentProcessingRequest equipmentProcessingRequest) throws Exception {
        ...
        String patternFirst = CodeMapping.BTR4DL_PATTERN_FIRST.getDescription();
        String patternDate = CodeMapping.BTR4DL_PATTERN_DATE.getDescription();
        String patternSpace = CodeMapping.BTR4DL_PATTERN_SPACEANDSIZEWORD.getDescription();
        String numberSearch = CodeMapping.BTR4DL_PATTERN_NUMBER_SEARCH.getDescription();
        String patternNumber = CodeMapping.BTR4DL_PATTERN_NUMBER.getDescription();
        String replaceNumber = CodeMapping.BTR4DL_PATTERN_REPLACE_NUMBER.getDescription();
        int fontSize = CodeMapping.BTR4DL_PATTERN_SPACEANDSIZEWORD.getSize();
