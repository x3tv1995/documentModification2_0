...
@Component("КЭКМ")
public class KekmEquipmentHandler implements EquipmentHandler, EquipmentHandlerForPsi {
    @Autowired
    ...
    public void handler(String pathExcel, String docPath, String pathDirectory,
        ...
        String patternFirst = CodeMapping.KEKM_PATTERN_FIRST.getDescription();
        String patternDate = CodeMapping.KEKM_PATTERN_DATE.getDescription();
        String patternSpace = CodeMapping.KEKM_PATTERN_SPACEANDSIZEWORD.getDescription();
        String numberSearch = CodeMapping.KEKM_PATTERN_NUMBER_SEARCH.getDescription();
        String patternNumber = CodeMapping.KEKM_PATTERN_NUMBER.getDescription();
        String replaceNumber = CodeMapping.KEKM_PATTERN_REPLACE_NUMBER.getDescription();
        int fontSize = CodeMapping.KEKM_PATTERN_SPACEANDSIZEWORD.getSize();
