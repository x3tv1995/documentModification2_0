...
@Component("ТВКМ5000")
public class Tvkm5000EquipmentHandler implements EquipmentHandler, EquipmentHandlerForPsi {
    @Autowired
    ...
    public void handler(EquipmentProcessingRequest equipmentProcessingRequest) throws Exception {
        ...
        String patternFirst = CodeMapping.TVKM5000_PATTERN_FIRST.getDescription();
        String patternDate = CodeMapping.TVKM5000_PATTERN_DATE.getDescription();
        String patternSpace = CodeMapping.TVKM5000_PATTERN_SPACEANDSIZEWORD.getDescription();
        String numberSearch = CodeMapping.TVKM5000_PATTERN_NUMBER_SEARCH.getDescription();
        String patternNumber = CodeMapping.TVKM5000_PATTERN_NUMBER.getDescription();
        String replaceNumber = CodeMapping.TVKM5000_PATTERN_REPLACE_NUMBER.getDescription();
        int fontSize = CodeMapping.TVKM5000_PATTERN_SPACEANDSIZEWORD.getSize();
    ...
    public void handlerPsi(String lastName, XWPFDocument document, int sizeText) {
        String patternFirst = CodeMapping.TVKM5000_PSI_PATTERN_FIRST.getDescription();
        String patternDate =  CodeMapping.TVKM5000_PSI_PATTERN_DATE.getDescription();
