...
@Component("ВВЭК11400")
public class Vvek11400EquipmentHandler implements EquipmentHandler, EquipmentHandlerForPsi {
    @Autowired
    ...
    public void handler(EquipmentProcessingRequest equipmentProcessingRequest) throws Exception {
        ...
        String patternFirst = CodeMapping.VVEK11400_PATTERN_FIRST.getDescription();
        String patternDate = CodeMapping.VVEK11400_PATTERN_DATE.getDescription();
        String patternSpace = CodeMapping.VVEK11400_PATTERN_SPACEANDSIZEWORD.getDescription();
        String numberSearch = CodeMapping.VVEK11400_PATTERN_NUMBER_SEARCH.getDescription();
        String patternNumber = CodeMapping.VVEK11400_PATTERN_NUMBER.getDescription();
        String replaceNumber = CodeMapping.VVEK11400_PATTERN_REPLACE_NUMBER.getDescription();
        int fontSize = CodeMapping.VVEK11400_PATTERN_SPACEANDSIZEWORD.getSize();
    ...
    public void handlerPsi(String lastName, XWPFDocument document, int sizeText) {
        ...
        String patternDate =  CodeMapping.VVEK_PSI_PATTERN_DATE.getDescription();
